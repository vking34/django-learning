...
class HomeTests(TestCase):
    ...
    def test_home_view_status_code(self):
        self.assertEquals(self.respone.status_code, 200)
    ...
    def test_home_view_contains_link_to_topics_page(self):
        ...
        self.assertContains(self.respone, 'href="{0}"'.format(board_topics_url))
...
class BoardTopicsTests(TestCase):
    ...
    # def test_board_topics_view_contains_link_back_to_index(self):
    #     board_topics_url = reverse('boards:board_topics', kwargs={'board_id': 1})
    #     response = self.client.get(board_topics_url)
    #     index_url = reverse('boards:index')
...
class NewTopicTests(TestCase):
    ...
    def test_new_topic_view_contians_link_back_to_board_topics_view(self):
        new_topic_url = reverse('boards:new_topic', kwargs={'pk': 1})
